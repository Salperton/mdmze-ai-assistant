      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-center gap-16 mb-8">
          ...
          <div className="text-center">
            ...
            <div className="space-y-1 text-sm" style={{ fontFamily: 'Figtree, sans-serif' }}>
              <p>Dubai Media City</p>
              <p>Boutique Villa 12</p>
              <p>Dubai, UAE</p>
            </div>
          </div>
        ...
        >
          © All Rights Reserved – Mind Maze Family Support Centre
        </p>
      </div>
    </footer>
  );
